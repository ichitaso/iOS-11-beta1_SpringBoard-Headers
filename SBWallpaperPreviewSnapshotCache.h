...
- (id)_snapshotProviderForVariant:(long long)arg1 options:(unsigned long long)arg2;
- (id)_lockScreenSnapshotProviderWithOptions:(unsigned long long)arg1;
- (id)_homeScreenSnapshotProviderWithOptions:(unsigned long long)arg1;
...
- (id)snapshotForVariant:(long long)arg1 options:(unsigned long long)arg2;
