...
#import "SBIconListViewDropSessionDidEndObserver.h"

@class NSMapTable, NSString, NSTimer, SBIconController, SBIconDraggingEditContext;

@interface SBIconDragManager : NSObject <SBIconListViewDropSessionDidEndObserver, SBAlertManagerObserver, SBAlertItemsControllerObserver, SBAssistantObserver>
{
    NSMapTable *_iconDrags;
    NSMapTable *_uniqueIdentifiersPerDropSession;
    SBIconController *_iconController;
    id _recipientIconOwningDrag;
...
@property(retain, nonatomic) id recipientIconOwningDrag; // @synthesize recipientIconOwningDrag=_recipientIconOwningDrag;
...
- (_Bool)revertLocationForIcon:(id)arg1 toOrigin:(id)arg2;
- (id)fullIndexPathForIconOrigin:(id)arg1 icon:(id)arg2;
...
- (void)_dropIcon:(id)arg1 withInsertionPath:(id)arg2 hideIconView:(_Bool)arg3 dragContext:(id)arg4;
- (void)replaceAllGrabbedIconViewsWithPlaceholders;
