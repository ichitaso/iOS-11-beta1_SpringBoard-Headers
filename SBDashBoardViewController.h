...
#import "SBCoverSheetSecureAppLaunching.h"
...
@class BSTimer, FBDisplayLayoutTransition, NSArray, NSHashTable, NSSet, NSString, SBAppStatusBarSettingsAssertion, SBDashBoardAppearance, SBDashBoardBehavior, SBDashBoardChargingViewController, SBDashBoardHomeButtonShowPasscodeRecognizer, SBDashBoardIdleTimerProvider, SBDashBoardLegibilityProvider, SBDashBoardMainPageContentViewController, SBDashBoardMesaUnlockBehavior, SBDashBoardMesaUnlockBehaviorConfiguration, SBDashBoardModalPresentationViewController, SBDashBoardNotificationClearingTrigger, SBDashBoardNotificationDispatcher, SBDashBoardPluginViewController, SBDashBoardPowerChangeObserver, SBDashBoardPresentation, SBDashBoardScrollGestureController, SBDashBoardSetupViewController, SBInProcessSecureAppAction, SBLockScreenActionManager, SBLockScreenDateViewController, SBLockScreenPluginManager, SBLockScreenSettings, SBLockScreenTimerViewController, SBMainDisplayPolicyAggregator, SBMainStatusBarStateProvider, SBScreenWakeAnimationController, SBSteppedAnimationTimingFunctionCalculator, SBWallpaperAggdLogger, UIColor, UIStatusBar, UITapGestureRecognizer, UIVisualEffectView, _UILegibilitySettings;

@interface SBDashBoardViewController : SBLockScreenViewControllerBase <SBDashBoardViewDelegate, UIGestureRecognizerDelegate, SBDashBoardLegibilityProviderDelegate, SBLockScreenActionProvider, SBLockScreenPluginManagerDelegate, SBFIrisWallpaperViewDelegate, SBDashBoardViewTransitionSource, SBDashBoardNotificationDestination, SBLockScreenTimerViewControllerDelegate, SBDashBoardMesaUnlockBehaviorConfigurationDelegate, SBMesaUnlockBehaviorDelegate, _UISettingsKeyObserver, SBDashBoardScrollGestureControllerDelegate, SBDashBoardIdleTimerProviderDelegate, SBDashBoardNotificationClearingTriggerDelegate, SBDashBoardSpotlightViewControllerDelegate, SBDashBoardViewControllerProtocol, SBCoverSheetSecureAppLaunching>
{
...
- (void)_activateAppSceneFromTransitionRequest:(id)arg1 interactive:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)activateCameraBelowDashBoardInteractive:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;
