...
@class NSHashTable, NSString, SBBestAppSuggestion, SBCloseBoxView, SBFParallaxSettings, SBFolderIconBackgroundView, SBIcon, SBIconImageCrossfadeView, SBIconImageView, UIDragInteraction, UIGestureRecognizer, UITapGestureRecognizer, UIView<SBIconAccessoryView>, UIView<SBIconLabelView>, UIView<SBReusableView>, _UILegibilitySettings;

@interface SBIconView : UIView <_UISettingsKeyObserver, UIGestureRecognizerDelegate, UIDragInteractionDelegate, SBIconObserver, SBReusableView, SBIconAccessoryInfoProvider>
{
    SBIcon *_icon;
    ...
    unsigned int _currentLabelAccessoryType:2;
    ...
    unsigned int _allowPositionJitter:1;
...
+ (double)labelAccessoryViewRightMarginForType:(unsigned long long)arg1;
...
@property(readonly, nonatomic) unsigned long long currentLabelAccessoryType; // @synthesize currentLabelAccessoryType=_currentLabelAccessoryType;
...
- (void)_updateDragInteractionGestureConfiguration;
...
@property(nonatomic) _Bool allowsPositionJitter;
...
- (void)_configureLabelAccessoryViewForType:(unsigned long long)arg1;
