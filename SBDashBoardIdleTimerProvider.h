...
@class NSMutableSet, NSString, SBIdleTimerDescriptor, SBIdleTimerDescriptorFactory;

@interface SBDashBoardIdleTimerProvider : NSObject <SBIdleTimerObserving>
{
    SBIdleTimerDescriptorFactory *_idleTimerFactory;
    id <SBIdleTimer> _idleTimer;
    SBIdleTimerDescriptor *_idleTimerDescriptor;
...
- (id)idleTimerDescriptorForIdleDimProvider:(id)arg1 reason:(id)arg2;
- (void)resetIdleTimer;
- (void)dealloc;
