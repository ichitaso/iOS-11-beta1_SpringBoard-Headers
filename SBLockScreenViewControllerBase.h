...
@interface SBLockScreenViewControllerBase : UIViewController <SBScreenWakeAnimationControllerDelegate, SBAutoUnlockRule, SBMesaUnlockBehavior, SBButtonEventsHandler, SBApplicationHosting, SBIdleTimerProviding, SBScreenWakeAnimationTarget>
{
...
- (void).cxx_destruct;
- (id)_wakeEffectsForWakeState:(long long)arg1;
