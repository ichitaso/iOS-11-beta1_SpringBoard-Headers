...
@class SBAlertItemsSettings, SBAnimationFactorySettings, SBAppIconForceTouchSettings, SBAppParallaxSettings, SBAppSwitcherSettings, SBAttentionAwarenessSettings, SBCarDisplaySettings, SBFWallpaperSettings, SBFolderSettings, SBHarmonySettings, SBHomeButtonSettings, SBHomeScreenSettings, SBIconColorSettings, SBIrisWallpaperSettings, SBLegibilitySettings, SBLockScreenSettings, SBLockScreenTestPluginSettings, SBMedusa2oSettings, SBMedusaSettings, SBMiscellaneousSystemAnimationSettings, SBPrototypeControllerSettings, SBReachabilitySettings, SBRootAnimationSettings, SBStatusBarStyleOverridesSettings, SBWakeAnimationSettings;
