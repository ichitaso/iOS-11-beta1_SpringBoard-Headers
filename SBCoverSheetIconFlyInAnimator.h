...
@class CAMediaTimingFunction, NSString, UIViewProgressAnimatableProperty;
...
@interface SBCoverSheetIconFlyInAnimator : SBCenterIconZoomAnimator <_UISettingsKeyObserver>
{
    ...
    UIViewProgressAnimatableProperty *_fractionAnimatableProperty;
    CAMediaTimingFunction *_timingFunction;
}

@property(retain, nonatomic) CAMediaTimingFunction *timingFunction; // @synthesize timingFunction=_timingFunction;
@property(retain, nonatomic) UIViewProgressAnimatableProperty *fractionAnimatableProperty; // @synthesize fractionAnimatableProperty=_fractionAnimatableProperty;
- (void).cxx_destruct;
