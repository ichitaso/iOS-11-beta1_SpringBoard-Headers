...
@class BBDataProviderConnection, NSArray, NSDate, NSHashTable, NSMutableArray, NSMutableSet, NSNumberFormatter, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSSet, NSString, NSTimer, SBAccountStoreManager, SBAppStatusBarSettingsAssertion, SBApplication, SBApplicationAutoLaunchService, SBApplicationLaunchAlertService, SBBluetoothAccessoryBatteryMonitor, SBCarDoNotDisturbController, SBCardItemsController, SBCombinationHardwareButton, SBFUserAuthenticationController, SBHomeHardwareButton, SBIdleTimerPolicyAggregator, SBLockHardwareButton, SBMainDisplayInterfaceOrientationAggregator, SBMainWorkspace, SBModalAlertPresentationCoordinator, SBModalAlertPresenter, SBNCNotificationDispatcher, SBPowerDownController, SBPressPrecedenceArbiter, SBRestartManager, SBSStatusBarStyleOverridesAssertion, SBScreenshotManager, SBSpotlightAlert, SBSynchronizeCloudCriticalDataOperation, SBUIController, SBUserSessionController, SBVolumeHardwareButton, SBWidgetController, SSScreenCapturer, UIWindow;
...
@property(retain, nonatomic) SBSpotlightAlert *spotlightAlert; // @synthesize spotlightAlert=_spotlightAlert;
