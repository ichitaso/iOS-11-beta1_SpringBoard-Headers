...
@class BSTimer, NSArray, NSMutableArray, NSSet;
...
@interface SBPressGestureRecognizer : UIGestureRecognizer
{
    ...
    _Bool __isDispatchingPresses;
    BSTimer *_waitingForPreemptionTimer;
    double _lastPrecedencePressesTimestamp;
...
- (void)__waitGestureStateExpirationWithFireInterval:(double)arg1 timerExpiredActionBlock:(CDUnknownBlockType)arg2;
- (void)_updatePublicPressInfo:(id)arg1;
- (void)_applyGestureStateInfo:(id)arg1;
- (void)_updateUnbalancedPressBeganTypesWithCurrentPressType:(long long)arg1 andPhase:(long long)arg2;
...
- (_Bool)__isDispatchingDelayedPresses;
- (void)__startDispatchingDelayedPresses;
