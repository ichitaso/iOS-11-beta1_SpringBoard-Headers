...
@class NSArray, NSMapTable, NSString, NSTimer, SBAppStatusBarSettingsAssertion, SBFloatingDockBehaviorAssertion, SBFolder, SBFolderContainerView, SBFolderContext, SBFolderControllerAnimationContext, SBFolderControllerBackgroundView, SBFolderView, SBIconAnimator, SBIconViewMap, UIStatusBar, UIView, UIWindow, _UILegibilitySettings;

@interface SBFolderController : SBNestingViewController <SBFolderControllerDelegate, SBFolderObserver, SBFolderViewDelegate, SBScaleIconZoomAnimationContaining, BSDescriptionProviding>
{
...
- (void)noteIconDragDidExit:(id)arg1;
- (void)noteIconDragDidChange:(id)arg1;
- (void)noteIconDragDidEnter:(id)arg1;
- (void)noteUserIsInteractingWithIcons;
- (_Bool)_canHandleIconDropSession:(id)arg1 inListView:(id)arg2;
- (void)_updateDropDestinationForDrag:(id)arg1;
