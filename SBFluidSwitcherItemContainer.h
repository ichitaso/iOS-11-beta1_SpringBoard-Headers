...
@interface SBFluidSwitcherItemContainer : UIView <UIScrollViewDelegate, UIGestureRecognizerDelegate, SBFluidSwitcherItemContainerHeaderViewDelegate, SBFailureNotifyingTapGestureRecognizerDelegate>
{
    ...
    UIView *_viewForCloseBoxWallpaperPosition;
...
+ (_Bool)_deviceSupportsBlur;
+ (double)iconSize;
+ (double)spacingBetweenLeadingEdgeAndIcon;
+ (double)spacingBetweenSnapshotAndTextBaseline;
...
- (void)_updateWallpaperRelativeCloseBoxPosition;
...
- (void)updatePositionRelativeToWallpaperView:(id)arg1;
...
- (id)initWithFrame:(struct CGRect)arg1 appLayout:(id)arg2 delegate:(id)arg3;
