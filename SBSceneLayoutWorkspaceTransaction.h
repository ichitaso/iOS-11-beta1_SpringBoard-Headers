...
@class FBDisplayLayoutTransition, FBSynchronizedTransactionGroup, NSMutableSet, NSSet, NSString, SBAlertManager, SBSceneBackgroundedStatusAssertion, SBWorkspaceApplicationSceneTransitionContext, SBWorkspaceTransitionRequest;
