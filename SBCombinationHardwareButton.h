...
@class NSString, SBClickGestureRecognizer, SBCombinationHardwareButtonActions, SBHomeHardwareButton, SBLockHardwareButton, SBPressGestureRecognizer, SBSOSClawGestureObserver, SBSOSLockGestureObserver;
...
- (void)sosClawDidTriggerSOS:(id)arg1;
