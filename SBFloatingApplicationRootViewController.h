...
@interface SBFloatingApplicationRootViewController : SBFTouchPassThroughViewController <BSTransactionObserver, SBDeviceApplicationSceneHandleObserver, SBGrabberTongueDelegate, SBSystemGestureRecognizerDelegate>
{
    struct {
    ...
    _Bool _isStashedWithoutFloatingConfigurationUpdate;
...
- (void)_updateDiffuseShadowOffsetForFloatingConfiguration:(long long)arg1;
...
- (void)_replaceDeviceApplicationSceneViewControllerWithDeviceApplicationSceneHandle:(id)arg1 withActivationSettings:(id)arg2 interfaceOrientation:(long long)arg3 floatingConfiguration:(long long)arg4 modal:(_Bool)arg5;
- (id)_displayIdentity;
...
- (void)_updateDarkenViewAlphaAndFloatingApplicationViewDiffuseShadowForFloatingConfiguration:(long long)arg1;
