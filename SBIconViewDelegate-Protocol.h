...
@class NSArray, NSSet, SBFolder, SBIcon, SBIconView, UITargetedDragPreview, UITouch, UIView, UIView<SBIconAccessoryView>, UIView<SBReusableView>;

@protocol SBIconViewDelegate <NSObject>

@optional
- (void)removePlatterViewFromMedusaDragOffscreenWindow:(UIView *)arg1;
- (void)addPlatterViewToMedusaDragOffscreenWindow:(UIView *)arg1;
- (void)iconView:(SBIconView *)arg1 willRemoveLabelIconAccessoryView:(UIView<SBReusableView> *)arg2;
- (UIView<SBReusableView> *)iconView:(SBIconView *)arg1 iconLabelAccessoryViewOfType:(unsigned long long)arg2;
...
- (void)iconView:(SBIconView *)arg1 willAddDragItemsToSession:(id <UIDragSession>)arg2;
