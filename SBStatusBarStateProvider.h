...
@interface SBStatusBarStateProvider : NSObject <SBStatusBarStateAggregatorPosting, UIStatusBarStateProvider>
{
    ...
    CDStruct_121c720f _aggregatorData;
    int _aggregatorActions;
    CDStruct_121c720f _lastPost;
...
- (void).cxx_destruct;
- (void)statusBarStateAggregatorDidFinishPost:(id)arg1 withData:(const CDStruct_121c720f *)arg2 actions:(int)arg3;
- (void)statusBarStateAggregator:(id)arg1 didUpdateNonItemData:(const CDStruct_121c720f *)arg2;
- (void)statusBarStateAggregator:(id)arg1 didVisitItem:(int)arg2 withUpdates:(_Bool)arg3 toData:(const CDStruct_121c720f *)arg4;
- (void)statusBarStateAggregatorDidStartPost:(id)arg1;
- (void)_didFinishPost;
- (void)_composePostActionsFromAggregatorActions:(int *)arg1;
- (void)_composePostDataFromAggregatorData:(CDStruct_121c720f *)arg1;
- (_Bool)_shouldPostForUpdatesToNonItemData:(const CDStruct_121c720f *)arg1;
- (_Bool)_shouldPostForVisitedItem:(int)arg1 withUpdates:(_Bool)arg2 toAggregatorData:(const CDStruct_121c720f *)arg3 lastPost:(const CDStruct_121c720f *)arg4;
...
- (void)getStatusBarData:(CDStruct_121c720f *)arg1;
