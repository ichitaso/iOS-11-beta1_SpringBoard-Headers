...
@interface SBWorkspaceApplicationSceneTransitionContext : SBWorkspaceTransitionContext <SBDisplayLayoutContext>
{
    ...
    long long _requestedControlCenterPresentation;
}

@property(nonatomic) long long requestedControlCenterPresentation; // @synthesize requestedControlCenterPresentation=_requestedControlCenterPresentation;
