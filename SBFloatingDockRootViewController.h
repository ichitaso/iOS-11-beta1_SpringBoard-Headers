...
@class FBDisplayLayoutElement, NSString, SBAppSuggestionManager, SBApplicationController, SBFloatingDockViewController, SBFolderController, SBGrabberTongue, SBIconController, SBLayoutStateTransitionCoordinator, SBRecentDisplayItemsController, SBRecentDisplayItemsDataStore, UIPanGestureRecognizer, UIView, _UILegibilitySettings;
...
- (id)initWithIconController:(id)arg1 applicationController:(id)arg2 recentsController:(id)arg3 recentsDataStore:(id)arg4 appSuggestionManager:(id)arg5 transitionCoordinator:(id)arg6;
