...
@class NSArray, NSMutableArray, SBIconListModel, SBIconListViewDraggingDestinationDelegate, SBIconViewMap, UIFocusContainerGuide, UIFocusGuide;
...
@property(copy, nonatomic) NSArray *bouncedIcons; // @synthesize bouncedIcons=_bouncedIcons;
...
- (double)topIconInset;
- (void)addSessionDidEndObserver:(id)arg1 forDropSession:(id)arg2;
