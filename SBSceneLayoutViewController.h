...
@class FBDisplayLayoutElement, FBDisplayLayoutTransition, FBSDisplayIdentity, NSArray, NSMutableDictionary, NSString, SBLayoutState, SBSceneManager, SBWorkspaceApplicationSceneTransitionContext, UIView;
