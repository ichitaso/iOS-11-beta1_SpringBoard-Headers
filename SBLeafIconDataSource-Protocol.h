...
@class NSSet, NSString, SBLeafIcon, UIImage;

@protocol SBLeafIconDataSource <NSObject>
- (_Bool)icon:(SBLeafIcon *)arg1 launchFromLocation:(long long)arg2 context:(id)arg3 actions:(NSSet *)arg4;
...
- (_Bool)iconIsCloudDemoted:(SBLeafIcon *)arg1;
