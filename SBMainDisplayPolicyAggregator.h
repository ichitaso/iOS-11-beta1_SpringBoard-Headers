...
@class MCProfileConnection, SBAlertItemsController, SBApplicationController, SBAssistantController, SBCommandTabController, SBConferenceManager, SBInCallAlertManager, SBLocalDefaults, SBLockScreenManager, SBLockStateAggregator, SBMainWorkspace, SBNotificationBannerDestination, SBSetupManager, SBTelephonyManager;
...
@interface SBMainDisplayPolicyAggregator : SBPolicyAggregator
{
    ...
    SBInCallAlertManager *_override_inCallAlertManager;
...
@property(retain, nonatomic, getter=_inCallAlertManager, setter=_setInCallAlertManager:) SBInCallAlertManager *inCallAlertManager; // @synthesize inCallAlertManager=_override_inCallAlertManager;
