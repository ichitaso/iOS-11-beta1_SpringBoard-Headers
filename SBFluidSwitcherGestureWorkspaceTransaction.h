...
@class FBUIApplicationSceneDeactivationAssertion, NSString, SBAppLayout, SBFluidSwitcherViewController, SBMainWorkspaceTransaction;

@interface SBFluidSwitcherGestureWorkspaceTransaction : SBSystemGestureWorkspaceTransaction <BSTransactionObserver>
{
