...
@class NSMutableSet, NSString, SBAppStatusBarSettingsAssertion, SBAppSwitcherSettings, SBDismissOnlyAlertItem, SBHomeScreenWindow, SBIconContentView, SBSwitchAppList, SBSwitchAppSystemGestureRecognizer, SBSwitchAppSystemGestureWorkspaceTransaction, SBSwitcherSlideUpSystemGestureRecognizer, SBUIBackgroundView, UIForceStageInteractionProgress, UIStatusBar, UIView;
...
@interface SBUIController : NSObject <SBWallpaperObserver, _UISettingsKeyObserver, SBTouchTemplateGestureRecognizerDelegate, BSTransactionObserver, UIInteractionProgressObserver, UIWindowDelegate>
{
    ...
    SBUIBackgroundView *_homeScreenContentBackdropView;
...
- (int)dismissSheetsAndDetermineAlertStateForMenuClickOrSystemGesture;
...
- (void)launchIcon:(id)arg1 fromLocation:(long long)arg2 context:(id)arg3 actions:(id)arg4;
- (void)getRotationContentSettings:(CDStruct_e950349b *)arg1 forWindow:(id)arg2;
- (void)setHomeScreenBlurProgress:(double)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setHomeScreenScale:(double)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (void)setHomeScreenAlpha:(double)arg1 animated:(_Bool)arg2 completion:(CDUnknownBlockType)arg3;
- (id)scalingView;
- (id)contentView;
- (id)window;
