...
@class NSString, SBAccessibilityHardwareButtonInteraction, SBHardwareButtonActionList, SBHardwareButtonGestureParameters, SBHardwareButtonService, SBSiriHardwareButtonInteraction;
