...
@class NSHashTable, NSMutableSet, NSString, SBFWallpaperConfigurationManager, SBFWallpaperSettings, SBFWallpaperView, SBRootSettings, SBWallpaperAggdLogger, SBWallpaperControllerCoordinator, SBWallpaperStyleInfo, UIImage, UIScreen, UIView, UIView<SBUIWallpaperOverlay>, UIWindow;
