...
+ (double)prototypeSettingsGestureMaximumScale;
+ (double)prototypeSettingsPanGestureThresholdPercentage;
+ (double)prototypeSettingsPanGestureTravelDistance;
+ (_Bool)prototypeSettingsPinPanGestureShowsActualPreview;
