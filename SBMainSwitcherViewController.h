...
@class FBDisplayLayoutElement, FBUIApplicationSceneDeactivationAssertion, NSMutableArray, NSMutableDictionary, NSString, SBAppLayout, SBAppSwitcherRemoteAlertSet, SBAppSwitcherServiceSet, SBAppSwitcherSettings, SBBestAppSuggestion, SBMainDisplayLayoutState, SBMainDisplaySceneLayoutViewController, SBOrientationTransformWrapperView, SBWindow, UIViewController<SBMainAppSwitcherContentViewControlling>;
...
- (void)_insertAppLayout:(id)arg1 atIndex:(unsigned long long)arg2 completion:(CDUnknownBlockType)arg3;
