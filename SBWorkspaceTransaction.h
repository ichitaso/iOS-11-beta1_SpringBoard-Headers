...
@class FBSDisplayConfiguration, FBSDisplayIdentity, NSMutableSet, SBAlertManager, SBLayoutStateTransitionCoordinator, SBSceneLayoutViewController, SBUIAnimationController, SBWorkspaceTransitionRequest;
