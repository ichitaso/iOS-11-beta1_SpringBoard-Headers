...
@class SBFolder, SBFolderController, SBIconListView, SBIconView, UIDragItem, UIDropProposal, UIPinchGestureRecognizer;
...
- (void)folderController:(SBFolderController *)arg1 iconListView:(SBIconListView *)arg2 iconDraggingEnded:(id <UIDropSession>)arg3;
- (void)folderController:(SBFolderController *)arg1 iconListView:(SBIconListView *)arg2 concludeIconDrop:(id <UIDropSession>)arg3;
